...
const WORKFLOW_STEPS = [
  {
    icon: Target,
    label: "Scope",
    desc: "Frame the problem (SCQA)",
    color: "text-blue-500",
  },
  {
    icon: Search,
    label: "Diagnose",
    desc: "Run 8 strategy frameworks",
    color: "text-indigo-500",
  },
  {
    icon: Network,
    label: "Hypothesize",
    desc: "Build hypothesis tree",
    color: "text-violet-500",
  },
  {
    icon: LineChart,
    label: "Analyze",
    desc: "Test each hypothesis",
    color: "text-purple-500",
  },
  {
    icon: Layers,
    label: "Synthesize",
    desc: "Pyramid principle",
    color: "text-fuchsia-500",
  },
  {
    icon: FileBarChart,
    label: "Communicate",
    desc: "Build slide deck",
    color: "text-pink-500",
  },
];
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center px-4 py-20 md:py-28">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            engagement — from problem scoping to slide deck export — using the
            same frameworks taught at top consulting firms.
          </p>
      ...
      <section className="px-4 py-16 bg-muted/40">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-10 max-w-2xl mx-auto">
            Every engagement follows the same rigorous 6-stage process used at
            top strategy firms, with human-in-the-loop gates at every critical
            decision.
          </p>
      ...
      <section className="px-4 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-10">
            Every framework has an interactive canvas and a specialized AI
            agent.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {FRAMEWORKS.map(fw => (
              <div
                key={fw}
                className="flex items-center gap-2 px-4 py-3 rounded-lg border bg-background"
              >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                icon: Layers,
                title: "MECE Everywhere",
                desc: "Every breakdown is mutually exclusive, collectively exhaustive. No overlaps, no gaps.",
              },
              {
                icon: Shield,
                title: "Hypothesis-First",
                desc: "Never gather data without a testable claim. Hypothesis before analysis, always.",
              },
              {
                icon: Workflow,
                title: "Human-in-the-Loop",
                desc: "5 gates where the AI must pause for human approval before proceeding.",
              },
              {
                icon: Compass,
                title: "So-What Discipline",
                desc: "Every finding must answer 'so what does this mean?' with actionable implications.",
              },
              {
                icon: Brain,
                title: "Pyramid Principle",
                desc: "Structure the narrative top-down before building any slides. Answer first.",
              },
              {
                icon: FileBarChart,
                title: "Grounded Claims",
                desc: "Every assertion needs a citation or evidence ID. No unsubstantiated claims.",
              },
            ].map(p => (
      ...
      <section className="px-4 py-20">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            Ready to think like a consultant?
          </h2>
